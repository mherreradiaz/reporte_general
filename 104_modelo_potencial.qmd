...
### Índices vegetacionales {.unnumbered}
...
![Esquemas de división utilizados para agrupar los conjuntos de entrenamiento y prueba: división aleatoria (rnd_split) y división temporal independiente (tme_split).](figuras/misc/esquema_split.png){#fig-split fig-align="center".lightbox}
